...
const routes: Routes = [
    ...
    { path: "sidebar", component: BlogComponent, canActivate: [AuthGuard] },
    { path: "blog-details", component: BlogDetailsComponent, canActivate: [AuthGuard] },
    { path: "food-collection", component: FoodCollectionComponent, canActivate: [AuthGuard] },
    { path: "online-order", component: OnlineOrderComponent, canActivate: [AuthGuard] },
